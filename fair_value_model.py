...
con = sqlite3.connect('fair_value_data.sqlite')
cur = con.cursor()
...
plt.plot(dates_for_test, test1_price, label="Test 1 Preformance", linewidth=2)
plt.plot(dates_for_test, test2_price, label="Test 2 Preformance", linewidth=2)
plt.ylabel("Portfolio Value ($)")
plt.xlabel("Date")
plt.title("Test 1 vs Test 2", fontsize=25)
plt.legend()
plt.show()